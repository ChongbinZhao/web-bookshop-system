...
class Book(models.Model):
    ...
    inventory = models.IntegerField('库存', default=1000)
...
class Orders(models.Model):
    id = models.AutoField('序号', primary_key=True)
    book_name = models.CharField('书名', max_length=32, null=True)
    customer_name = models.CharField('顾客名', max_length=32)
    number = models.IntegerField('购买数量', default=1)
    addr = models.CharField('顾客地址', max_length=254)
    mobile = models.BigIntegerField('手机', blank='True')
